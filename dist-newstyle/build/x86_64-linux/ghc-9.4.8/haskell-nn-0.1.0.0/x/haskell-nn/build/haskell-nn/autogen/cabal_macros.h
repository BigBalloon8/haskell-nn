...
/* package haskell-nn-0.1.0.0 */
#ifndef VERSION_haskell_nn
#define VERSION_haskell_nn "0.1.0.0"
#endif /* VERSION_haskell_nn */
#ifndef MIN_VERSION_haskell_nn
#define MIN_VERSION_haskell_nn(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_nn */
...
#define CURRENT_COMPONENT_ID "haskell-nn-0.1.0.0-inplace-haskell-nn"
